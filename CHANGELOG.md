...
## [0.2.4](https://github.com/marianfoo/open-rfc/compare/v0.2.3...v0.2.4) (2026-09-23)
...
* accept numeric and lowercase SAP logon language keys ([#36](https://github.com/marianfoo/open-rfc/issues/36)) ([5fcc2d6](https://github.com/marianfoo/open-rfc/commit/5fcc2d61bcc3dd82b6f7b8b95f5a026d1d7aebd3))
...
* decode single-byte SAP logon rejection text ([#37](https://github.com/marianfoo/open-rfc/issues/37)) ([565942d](https://github.com/marianfoo/open-rfc/commit/565942d8a49b1a239e323fc88be5332f49176e4c))
